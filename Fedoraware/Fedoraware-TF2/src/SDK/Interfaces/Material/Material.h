...
public:
	...
	{
		typedef MaterialHandle_t(* FN)(PVOID, MaterialHandle_t);
	...
	{
		typedef ITexture *( *FN)(PVOID, const char *, int, int, RenderTargetSizeMode_t, ImageFormat, MaterialRenderTargetDepth_t, unsigned int, unsigned int);
