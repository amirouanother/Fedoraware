...
public:
	...
	{
		typedef const matrix3x4 &( *FN)(PVOID);
	...
	{
		typedef ISpatialQuery *( *FN)(PVOID);
		return GetVFunc<FN>(this, 42)(this);
	}

	char const* GetLevelName()
	{
		typedef char const* (* FN)(PVOID);
